"""
Django settings for DTDM_BASE project.
...
SECRET_KEY = 'a&(xy=varkfgo!fyp#i0p-u5b!h_lwaj-0)doi^ltb%v#iv#11'
...
WSGI_APPLICATION = 'DTDM_BASE.wsgi.application'
